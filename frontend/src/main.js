...
import { LocationMap, initLocation } from './js/pages/LocationMap.js';
...
function renderContactPage() {
  const appHTML = `
    ${Navbar}
    <main class="relative z-0 overflow-clip w-full max-w-[100vw]">
      <div class="bg-[#0f0f0f]/45 backdrop-blur-sm relative z-10 min-h-screen pt-24 pb-12">
        ${QuoteSection}
      </div>
    </main>
    ${Footer}
...
function renderWhatsApp() {
  ...
  const waHtml = `
    <a id="wa-btn-container" href="https://wa.me/59178897815" target="_blank" rel="noopener noreferrer" class="fixed bottom-5 sm:bottom-6 right-4 sm:right-6 z-[100] group flex items-center justify-center">
      <!-- Glow pulsante -->
